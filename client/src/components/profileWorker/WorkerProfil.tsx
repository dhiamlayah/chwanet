...
import axios from 'axios';
 ...
 const WorkerProfil = ({profilPicture,WorkerInformations}:any) => {
   ...
   return ( 
      ...
      {number===1 &&  <WorkerDiscreption isMe={isMe} state={state} delegation={delegation} discreption={discreption} phone={phone} workName={workName}/>}
       </div>    
      );
 }
